        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cta-item mb-30">
                    ...
                    <p>Join with other subscribers and get a new discount coupon  on every Friday.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cta-item mb-30">
                    ...
                    <p>Kopdig-market kini bakal ada di Google Play. Segera......</p>
                    <div class="cta-apps">
                                ...
                                <div class="footer__widget">
                                    ...
                                    <div class="footer__widget">
                                        <div class="footer__widget-title mb-20">
                                            <h4>Tentang Platform kopdig-market</h4>
                                        </div>
                                        <div class="footer__widget-content">
                                            <p class="footer-text mb-35">Mendorong koperasi go-digital untuk meningkatkan perekonomian negara.</p>
                                            <div class="footer__hotline d-flex align-items-center mb-10">
                                                ...
                                                <div class="text">
                                                    ...
                                                    <span><a href="https://wa.me/6287872875432">(+62) 87872875432</a></span>
                                                </div>
                                            </div>
                                            <div class="footer__info">
                                                <ul>
                                                    <li>
                                                        <span>Add:  <a target="_blank" href="https://g.page/polijesip?share">Politeknik negeri jember</a></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="copy-right-area text-center">
                                <p>Copyright © 2022<span>Politeknik Negeri Jember.</span> All Rights Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
